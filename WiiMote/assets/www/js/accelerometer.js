...
var SPEED = 40;                 // Canvas redraw speed in milliseconds and accelerometer frequency
...
var RADIUS = 20;                // Width of circle object
var CIRCLE_COLOR = "#0000FF";      // Circle color
...
function draw() 
{
    ...
    canvas_ctx.beginPath();
	canvas_ctx.moveTo((WIDTH/2) - 125, (HEIGHT/2));
	canvas_ctx.lineTo((WIDTH/2) + 125, (HEIGHT/2));
	canvas_ctx.stroke();
	canvas_ctx.moveTo((WIDTH/2), (HEIGHT/2) - 125);
	canvas_ctx.lineTo((WIDTH/2), (HEIGHT/2) + 125);
	canvas_ctx.stroke();
	canvas_ctx.closePath();
